...
export const goldenMondayTranslations = {
  en: {
    ...
    // ─── QR Check-in — Extended (multi-flow) ─────────────────────
    qrHeaderAdminHint: "Show session QR or scan employee QR",
    qrHeaderEmployeeHint: "Scan the session QR to check in",
    qrShowSessionQR: "Show Session QR",
    qrShowSessionQRSub: "Employees scan this to check in",
    qrScanEmployeeQR: "Scan Employee QR",
    qrScanEmployeeQRSub: "Point camera at employee's QR",
    qrShowMyQR: "Show My QR",
    qrShowMyQRSub: "Let the coordinator scan you",
    qrScanSessionQR: "Scan Session QR",
    qrScanSessionQRSub: "Point camera at coordinator's QR",
    qrVerifiedNote: "Identity is verified server-side — no spoofing possible.",
    qrSessionModalTitle: "Session Check-In QR",
    qrSessionModalSub: "Employees scan this to mark themselves present",
    qrPersonalModalTitle: "Your Personal QR",
    qrPersonalModalSub: "Show this to the Golden Monday coordinator",
    qrSessionModalHint:
      '📱 Ask the person to open Golden Monday → "Scan QR" on their phone',
    qrScannerTitleSession: "Scan Session QR to Check In",
    qrScannerTitleEmployee: "Scan Employee's QR",
    qrScannerHintSession: "Point camera at the coordinator's session QR",
    qrScannerHintEmployee: "Point camera at the employee's personal QR",
    qrScannerDefaultTitle: "Scan QR Code",
    qrScannerDefaultHint: "Point the camera at the QR code",
    qrCameraStarting: "Starting camera…",
    qrCameraCloseBtn: "Close",
    qrCameraPermissionDenied:
      "Camera permission denied. Please allow camera access in your browser settings.",
    qrCameraNotFound: "No camera found on this device.",
    qrCameraOpenFailed: "Failed to open camera.",
    qrAlreadyCheckedInShort: "You've already checked in to this session",
    qrInvalidNotSession: "This QR is not a Golden Monday session code",
    qrInvalidNotSessionShort: "Invalid QR code — not a session code",
    qrCheckInEmployeeFailed: "Failed to check in employee",
  ...
  am: {
    ...
    // ─── QR Check-in — Extended (multi-flow) ─────────────────────
    qrHeaderAdminHint: "የክፍለ-ጊዜ QR ያሳዩ ወይም የሰራተኛ QR ይቃኙ",
    qrHeaderEmployeeHint: "ለመገኘት የክፍለ-ጊዜ QR ይቃኙ",
    qrShowSessionQR: "የክፍለ-ጊዜ QR አሳይ",
    qrShowSessionQRSub: "ሰራተኞች ለመገኘት ይህን ይቃኛሉ",
    qrScanEmployeeQR: "የሰራተኛ QR ቃኝ",
    qrScanEmployeeQRSub: "ካሜራውን ወደ ሰራተኛው QR ያነጣጥሩ",
    qrShowMyQR: "የእኔን QR አሳይ",
    qrShowMyQRSub: "አስተባባሪው እንዲቃኝዎ ይፍቀዱ",
    qrScanSessionQR: "የክፍለ-ጊዜ QR ቃኝ",
    qrScanSessionQRSub: "ካሜራውን ወደ አስተባባሪው QR ያነጣጥሩ",
    qrVerifiedNote: "ማንነት በሰርቨር ተረጋግጧል — ማጭበርበር አይቻልም።",
    qrSessionModalTitle: "የክፍለ-ጊዜ መግቢያ QR",
    qrSessionModalSub: "ሰራተኞች ራሳቸውን ለመመዝገብ ይህን ይቃኛሉ",
    qrPersonalModalTitle: "የእርስዎ የግል QR",
    qrPersonalModalSub: "ይህን ለወርቃማ ሰኞ አስተባባሪ ያሳዩ",
    qrSessionModalHint: '📱 ሰውየው ወርቃማ ሰኞ ከፍቶ "QR ቃኝ" እንዲጫን ይጠይቁ',
    qrScannerTitleSession: "ለመግባት የክፍለ-ጊዜ QR ቃኝ",
    qrScannerTitleEmployee: "የሰራተኛ QR ቃኝ",
    qrScannerHintSession: "ካሜራውን ወደ አስተባባሪው QR ያነጣጥሩ",
    qrScannerHintEmployee: "ካሜራውን ወደ ሰራተኛው የግል QR ያነጣጥሩ",
    qrScannerDefaultTitle: "QR ኮድ ቃኝ",
    qrScannerDefaultHint: "ካሜራውን ወደ QR ኮዱ ያነጣጥሩ",
    qrCameraStarting: "ካሜራ በመጀመር ላይ…",
    qrCameraCloseBtn: "ዝጋ",
    qrCameraPermissionDenied:
      "የካሜራ ፈቃድ ተከልክሏል። እባክዎ በአሳሽዎ ቅንብሮች ውስጥ የካሜራ መዳረሻን ይፍቀዱ።",
    qrCameraNotFound: "በዚህ መሳሪያ ላይ ካሜራ አልተገኘም።",
    qrCameraOpenFailed: "ካሜራ መክፈት አልተቻለም።",
    qrAlreadyCheckedInShort: "ለዚህ ክፍለ-ጊዜ አስቀድመው ገብተዋል",
    qrInvalidNotSession: "ይህ QR የወርቃማ ሰኞ ክፍለ-ጊዜ ኮድ አይደለም",
    qrInvalidNotSessionShort: "ልክ ያልሆነ QR ኮድ — የክፍለ-ጊዜ ኮድ አይደለም",
    qrCheckInEmployeeFailed: "ሰራተኛውን ማስገባት አልተቻለም",
  ...
  om: {
    ...
    // ─── QR Check-in — Extended (multi-flow) ─────────────────────
    qrHeaderAdminHint: "QR yeroo agarsiisi ykn QR hojjataa iskaani",
    qrHeaderEmployeeHint: "Seensuuf QR yeroo iskaani",
    qrShowSessionQR: "QR Yeroo Agarsiisi",
    qrShowSessionQRSub: "Hojjattoonni seensuuf kana iskaanuu",
    qrScanEmployeeQR: "QR Hojjataa Iskaani",
    qrScanEmployeeQRSub: "Kaameraa gara QR hojjataatti qajeelchi",
    qrShowMyQR: "QR Koo Agarsiisi",
    qrShowMyQRSub: "Qindeessaan si iskaanuuf hayyami",
    qrScanSessionQR: "QR Yeroo Iskaani",
    qrScanSessionQRSub: "Kaameraa gara QR qindeessaatti qajeelchi",
    qrVerifiedNote:
      "Eenyummeessi server irratti mirkanaa'e — sobuun hin danda'amu.",
    qrSessionModalTitle: "QR Seensa Yeroo",
    qrSessionModalSub: "Hojjattoonni of galmeessuuf kana iskaanuu",
    qrPersonalModalTitle: "QR Dhuunfaa Keessan",
    qrPersonalModalSub: "Kana qindeessaa Wiixata Warqee tiif argisiisi",
    qrSessionModalHint:
      '📱 Wiixata Warqee baniitii "QR Iskaani" tuquu gaafadhu',
    qrScannerTitleSession: "Seensuuf QR Yeroo Iskaani",
    qrScannerTitleEmployee: "QR Hojjataa Iskaani",
    qrScannerHintSession: "Kaameraa gara QR qindeessaatti qajeelchi",
    qrScannerHintEmployee: "Kaameraa gara QR dhuunfaa hojjataatti qajeelchi",
    qrScannerDefaultTitle: "Koodii QR Iskaani",
    qrScannerDefaultHint: "Kaameraa gara koodii QR qajeelchi",
    qrCameraStarting: "Kaameraan jalqabaa jira…",
    qrCameraCloseBtn: "Cufi",
    qrCameraPermissionDenied:
      "Hayyamni kaameraa dhorkameera. Maaloo qindaa'ina browser keessan keessatti hayyama kaameraa banadhaa.",
    qrCameraNotFound: "Meeshaa kana irratti kaameraan hin argamne.",
    qrCameraOpenFailed: "Kaameraa banuun hin dandeenye.",
    qrAlreadyCheckedInShort: "Yeroo kanaaf duraan seenaniittu",
    qrInvalidNotSession: "QR kun koodii yeroo Wiixata Warqee miti",
    qrInvalidNotSessionShort: "Koodii QR sirrii hin taane — koodii yeroo miti",
    qrCheckInEmployeeFailed: "Hojjataa galmeessuun hin dandeenye",
    ...
    confirmRemoveMessage:
      '"{name}" naanna\'iinsaa irraa balleessu mirkaneeffatteettaa?',
