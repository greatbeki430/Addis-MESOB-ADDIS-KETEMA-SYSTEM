// frontend/src/constants/translations/landing.js
...
export const landingTranslations = {
  en: {
    landing: {
      ...
      featureDailyForumReports: "Daily & Forum Reports",
      featureDocumentVault: "Document Vault",
      featureAiAssistant: "AI Assistant, everywhere",
      ...
      featureGoldenMondayBody:
        "Weekly capacity-building program — session recaps, presenter rotation, and AI-suggested topics, right inside the app.",
      featurePeerForumBody:
        "A shared space for teams to discuss cases and learn from one another day to day.",
      featureEvaluationBody:
        "Structured, criteria-based staff evaluation that feeds directly into recognition and growth planning.",
      featureDailyForumReportsBody:
        "Team leaders log activity once — it flows into analytics, PDFs, and leadership reviews automatically.",
      featureDocumentVaultBody:
        "Secure, traceable storage with AI auto-fill that reads scanned forms and populates them for you.",
      featureAiAssistantBody:
        "A floating assistant and inline AI summaries across dashboards and reports.",
      featureTeamUserManagementBody:
        "Admins manage teams, roles, and access from one control center — no spreadsheets required.",
  ...
  am: {
    landing: {
      ...
      featureEvaluation: "ግምገማ",
      featureDailyForumReports: "ዕለታዊና የመድረክ ሪፖርት",
      featureDocumentVault: "የሰነድ ማከማቻ",
      ...
      featureGoldenMondayBody:
        "ሳምንታዊ የአቅም ግንባታ መርሃ-ግብር — የስብሰባ ማጠቃለያ፣ የአቅራቢ ሽክርክር እና በAI የተጠቆሙ ርዕሶች በመተግበሪያው ውስጥ።",
      featurePeerForumBody:
        "ቡድኖች ጉዳዮችን ለመወያየትና በየቀኑ ከእርስ በርስ ለመማር የሚጠቀሙበት የጋራ ቦታ።",
      featureEvaluationBody:
        "በተዋቀሩ መስፈርቶች ላይ የተመሰረተ የሰራተኛ ግምገማ ለእውቅናና ለእድገት እቅድ በቀጥታ ግብዓት የሚሆን።",
      featureDailyForumReportsBody:
        "ቡድን መሪዎች እንቅስቃሴን አንዴ ይመዘግባሉ — ወደ ትንተና፣ PDFና ግምገማ ራሱ በራሱ ይፈስሳል።",
      featureDocumentVaultBody:
        "ደህንነቱ የተጠበቀ የሰነድ ማከማቻ፣ የተቃኙ ቅጾችን በራስ-ሰር በሚሞላ AI የተደገፈ።",
      featureAiAssistantBody:
        "በዳሽቦርድና ሪፖርቶች ላይ ተንሳፋፊ ረዳትና በውስጥ የተካተቱ የAI ማጠቃለያዎች።",
      featureTeamUserManagementBody:
  ...
  om: {
    landing: {
      ...
      featureEvaluation: "Madaallii",
      featureDailyForumReports: "Gabaasa Guyyaa fi Waltajjii",
      featureDocumentVault: "Kuusaa Ragaa",
      ...
      featureGoldenMondayBody:
        "Sagantaa dandeettii ijaarsaa torbanii — cuunfaa walga'ii, naanna'iinsa dhiheessituu, fi mata duree AI-n yaadame, appii keessatti.",
      featurePeerForumBody:
        "Bakka waloo garee waliin haala dubbachuuf fi guyyaa guyyaan waliin baruuf.",
      featureEvaluationBody:
        "Madaallii hojjetaa ulaagaa irratti hundaa'e kan beekamtii fi karoora guddinaatiif kallattiin galtee ta'u.",
      featureDailyForumReportsBody:
        "Hoogganoonni garee sochii yeroo tokko galmeessu — gara xiinxalaa fi PDF ofumaan dabra.",
      featureDocumentVaultBody:
        "Kuusaa ragaa nageenya qabu, dandeettii AI-tiin unka sikaanamee ofumaan guutu.",
      featureAiAssistantBody:
        "Deeggartuu dafqee fi cuunfaa AI dashboard fi gabaasaa keessatti.",
      featureTeamUserManagementBody:
      ...
      servicesSub:
        "Tajaajiloota argaman hunda ilaali. Tajaajila guutuu fi bulchiinsa argachuuf seeni.",
      searchServices: "Tajaajiloota barbaadi...",
      showingServices: "Argisiisaa jira",
      of: "keessaa",
      ...
      loadingServices: "Tajaajiloota dataabase irraa fe'aa jira...",
