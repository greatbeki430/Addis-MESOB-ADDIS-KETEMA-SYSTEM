...
export default function ForumReport({ t, lang, selectedTeam, onReportSaved }) {
  ...
  const handleApplySuggestion = (text) => {
    ...
    // Store AI generated content for reference
          ...
          >
            ...
            <button
              onClick={() => {
                ...
                // The AIReportAssistant component handles this internally
                // We'll use the handleGenerateSummary as fallback
