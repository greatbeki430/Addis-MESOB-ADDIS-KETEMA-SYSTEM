...
export default function Header({ t, lang, setLang, onAddUserClick }) {
  ...
  // ─── Retry scrolling until the target section exists ───
  ...
  // Only show landing nav on landing page
  const showLandingNav = isOnLanding;
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* ── Landing Page Navigation (ONLY on landing page) ── */}
          {showLandingNav && (
            <div
